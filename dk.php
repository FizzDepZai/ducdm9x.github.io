...
// Tri
// Khởi tạo:
let tool = new RegistrationTool();
tool.init();
//

let codes = ["68","69","70","71"]; //linh
tool.registerSubjects(codes);


let codes = ["11","140","102","53","91","70","21","3","98"]; // ly
tool.registerSubjects(codes);

let codes = ["663","738","1039","331","201","78","460","512","812"]; //hoang anh
tool.registerSubjects(codes);
